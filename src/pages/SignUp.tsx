      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-end p-12 pb-16">
          ...
          <h2 className="text-white text-4xl font-display font-bold leading-tight mb-4">
            Start your journey<br />with ROOMi
          </h2>
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Join ROOMi and discover stays you'll never forget.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              ...
              <Label htmlFor="terms" className="text-sm font-normal cursor-pointer leading-snug">
                I agree to the{' '}
                <a href="#" className="text-gold hover:text-gold-dark underline">Terms of Service</a>
                {' '}and{' '}
                <a href="#" className="text-gold hover:text-gold-dark underline">Privacy Policy</a>
              </Label>
            </div>
