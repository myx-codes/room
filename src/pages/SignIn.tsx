  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        clearAccessToken()
        setFormError(t('auth.sessionFailed'))
        return
      }
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="memberNick">{t('common.memberNick')}</Label>
            ...
            <Button type="submit" className="w-full h-12 text-base font-medium" disabled={loginLoading || checkAuthLoading}>
              {loginLoading || checkAuthLoading ? t('auth.signingIn') : t('common.signIn')}
            </Button>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-background text-muted-foreground">{t('common.continueWith')}</span>
            </div>
          </div>
